...
/**
 * Prescription model class representing medication prescriptions
 */
public class Prescription {
    ...
    public String toCsvString() {
        return String.join(",",
            prescriptionId, patientId, clinicianId,
            appointmentId != null ? appointmentId : "",
            prescriptionDate, medicationName, dosage, frequency,
            String.valueOf(durationDays), quantity, instructions,
            pharmacyName, status, issueDate,
